  ...
  return (
    <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo leading-8">
        I'm available for freelance projects and remote opportunities. Feel free
        to reach out if you need a full-stack web application or backend
        solution. please use the form below.
      </p>
